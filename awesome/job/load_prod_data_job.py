...
def load_as_log():
    file_path = '/Users/admin/Documents/pythonprojects/pyspark_study/files/load_prod_data/cpc_bd_as_log.csv'
    dfs_file_path = 'hdfs://zjkb-cpc-backend-bigdata-qa-01:8020/user/hive/warehouse/dl_cpc.db/cpc_bd_as_log'
    schema_path = '/Users/admin/Documents/pythonprojects/pyspark_study/files/load_prod_data/bd_raw_log_schema.json'
    database = 'dl_cpc'
    table = 'cpc_bd_as_log'
...
def load_adx_log():
    file_path = '/Users/admin/Documents/pythonprojects/pyspark_study/files/load_prod_data/cpc_bd_adx_log.csv'
    dfs_file_path = 'hdfs://zjkb-cpc-backend-bigdata-qa-01:8020/user/hive/warehouse/dl_cpc.db/cpc_bd_adx_log'
    schema_path = '/Users/admin/Documents/pythonprojects/pyspark_study/files/load_prod_data/bd_raw_log_schema.json'
    database = 'dl_cpc'
    table = 'cpc_bd_adx_log'
    partition_columns = ['day', 'hour', 'minute']
    job = LoadProdDataJob(database,
                          table,
                          file_path,
...
def load_bs_log():
    file_path = '/Users/admin/Documents/pythonprojects/pyspark_study/files/load_prod_data/cpc_bd_recall_log.csv'
    dfs_file_path = 'hdfs://zjkb-cpc-backend-bigdata-qa-01:8020/user/hive/warehouse/dl_cpc.db/cpc_bd_recall_log'
    schema_path = '/Users/admin/Documents/pythonprojects/pyspark_study/files/load_prod_data/bd_raw_log_schema.json'
    database = 'dl_cpc'
    table = 'cpc_bd_recall_log'
    partition_columns = ['day', 'hour', 'minute']
    job = LoadProdDataJob(database,
                          table,
                          file_path,
